<header class="max-w-xl mx-auto mt-20 text-center">
    ...
    <h2 class="text-3xl"><span class="text-blue-500">ATWIMA MPONUA RURAL BANK LTD</span> </h2>
</br>
     <h2 class="inline-flex mt-2">Powered by Owusu-Mensah Bernard &nbsp; <img src="/images/avatar.png"
        alt="Head of Lary the mascot" width="30" height="7">
    </h2>
 ...
 <div class="relative flex lg:inline-flex items-center bg-gray-100 rounded-xl">
   ...
   {{ isset($currentCategory) ? ucwords($currentCategory->name) : 'Categories' }}
    ...
    @foreach ($categories as $category)
      <a href="/categories/{{ $category->slug }}" class="block text-left px-3 text-sm 
      leading-6 hover:bg-blue-500 focus:bg-blue-500 hover:text-white focus:text-white"> 
